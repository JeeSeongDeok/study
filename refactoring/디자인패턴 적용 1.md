...
public class CoordinatorMessageHandler {
    ...
    public void setMessage(FormattedFrame frame) {
    ...
    private CoordinatorMessage getMessageType(FormattedFrame frame) {
...
public class FireDetect implements CoordinatorMessage{
    public FireDetect(FormattedFrame ff) {
        // 필요한거 세팅~
    }
...
public interface CoordinatorMessageFactory {
    CoordinatorMessage getCoordinatorMessage(FormattedFrame frame);
}

public class SimpleCoordinatorMessageFactory implements CoordinatorMessageFactory {

    @Override
    public CoordinatorMessage getCoordinatorMessage(FormattedFrame frame) {
        switch (frame.getMsg_id()) {
            case EMG_KEY_MSG:
